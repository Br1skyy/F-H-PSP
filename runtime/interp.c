/* FhInterp — see interp.h. Covers codes in frequency order (see md §11 log):
 * structural spine + switches/vars/text/choices/waits, common events, party,
 * routes, tint, SE, states, items, HP/MP, anims, locate, transparency,
 * followers, actor graphic, transfer, balloons, erase, scroll, escapes,
 * script ops, plugin dispatch. Everything else: `unknown`, skip, don't crash.
 */
#include "interp.h"
#include <string.h>
#include <stdio.h>
